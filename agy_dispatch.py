...
Usage:
  python agy_dispatch.py --task-file STAGING/foo.md [--account laurethayday]
    ...
    try:
        ...
        if not _is_pythonw and os.environ.get("AGY_DISPATCH_RELAUNCHED") != "1":
            ...
            _pythonw_candidates.extend([
                ...
                r"C:\Users\ydbil\AppData\Local\Programs\Python\Python313\pythonw.exe",
            ])
...
AGY_EXE = r"C:\Users\ydbil\AppData\Local\agy\bin\agy.exe"
