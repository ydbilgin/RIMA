...
| 18 | **Item System D kilitleme** | Hybrid: Relic (2+1 garantili/run) + Skill Modifier (2+1 garantili/run). Ekipman slot yok, stat bloat yok. Kaynak: Treasure room / mini-boss / elite / shop. **HYBRID extension 2026-05-14 (Karar #125 entegrasyon):** Core "no stat-bearing equipment slot, drop economy yok" korunur. **Genişleme:** "Class identity-bound secondary weapon" (Karar #125) istisna — secondary weapon class doğuştan sahip, run-içi drop YOK, stat eklemiyor (sadece mechanic/visual). Karar #18'in özü (relic + skill modifier ekonomisi) bozulmaz. | 2026-04-14 |
...
| #126 | Organic Room Dressing Pipeline (9-stage umbrella) | LOCKED. Tilemap Base → WangResolver → Decal overlay → Scatter brush → Stamp/Cluster → Path readability → Biome preset SO → Naturalness Validator → PixelLab Pro re-gen pass. #127-130 alt karar. | 2026-05-14 |
| #127 | Stamp/Cluster Library (handcrafted hissi) | LOCKED. Faz 1.5 P1. Handcrafted 3-7 tile cluster ScriptableObject library; Room Designer one-click stamp. | 2026-05-14 |
| #128 | Tile Metadata SO + WangResolver (16-tile NSEW) | LOCKED. Faz 1 P0. TileAssetMetadata SO, 16-tile NSEW WangTileResolver, #118a TileImportWizard integration, Karar #115 seed compliance. | 2026-05-14 |
| #129 | Biome Preset SO (F1 Shattered Keep MVP) | LOCKED. Faz 1 P0. RimaBiomePreset ScriptableObject, allowed terrain/decal/scatter/palette tags, RimaBiomeType enum upgrade. | 2026-05-14 |
| #130 | Naturalness Validator + Path Readability editor | LOCKED. Faz 1.5 P1. Editor validator for unnatural patterns plus walkable path minimum 2-tile width pre-PixelLab check. | 2026-05-14 |
| #131 | Corner Wang Pipeline | LOCKED. PixelLab JSON → CornerWangTileSetSO → CornerWangPainter → Tilemap. Universal 16-key lookup. 6 tileset. Sinırsız layer/tileset. Tüm mapler agent-driven `int[,]` vertex grid. | 2026-05-14 |
| #132 | Map Designer EditorWindow | LOCKED. RimaMapDesignerWindow: vertex grid editor, Wang thumbnails, procedural gen, save/load JSON, multi-layer. RIMA > Tools > Map Designer. | 2026-05-14 |
