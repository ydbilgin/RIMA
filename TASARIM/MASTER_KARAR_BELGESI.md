...
| 16 | **Elementalist Light elementi** | Arcane kaldırıldı. Light = synthesis state (Fire+Frost Resonance → Lightbreak). 4 yeni skill: Prism Lance, Halo Fracture, Sunshard Torrent, Luminary Surge. Build axis: Radiant Break. | 2026-04-14 |
...
> RiftParry.cs + ParryFeedback.cs + ClassParryBonus.cs → `_ARCHIVE/`'e taşı.
