...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/idle/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/walk/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/run/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/heavy_attack/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/skill_cast/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/hurt/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/death/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/dash_attack/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/animations/dash/`
...
Kaydet: `_STAGING/Characters/Players/Warblade/animations/basic_attack/`
...
```
Kaydet: `_STAGING/Characters/Players/Elementalist/animations/idle/`
...
```
Kaydet: `_STAGING/Characters/Players/Elementalist/animations/walk/`
...
```
Kaydet: `_STAGING/Characters/Players/Elementalist/animations/run/`
...
```
Kaydet: `_STAGING/Characters/Players/Elementalist/animations/cast/`
...
```
Kaydet: `_STAGING/Characters/Players/Elementalist/animations/hurt/`
...
```
Kaydet: `_STAGING/Characters/Players/Elementalist/animations/death/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/idle/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/walk/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/run/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/basic_attack/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/heavy_attack/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/dash_attack/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/dash/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/hurt/`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/animations/death/`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/animations/idle/`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/animations/walk/`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/animations/run/`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/animations/skill_cast/`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/animations/dash/`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/animations/hurt/`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/animations/death/`
...
Onay gelince `confirm_cost=true` ile tekrarla.
Kaydet: `_STAGING/Characters/Players/Ranger/animations/basic_attack/`
...
```
Kaydet: `_STAGING/Enemies/Act1/ShardWalker/animations/idle/`
...
```
Kaydet: `_STAGING/Enemies/Act1/ShardWalker/animations/walk/`
...
```
Kaydet: `_STAGING/Enemies/Act1/ShardWalker/animations/attack/`
...
```
Kaydet: `_STAGING/Enemies/Act1/ShardWalker/animations/hurt/`
...
```
Kaydet: `_STAGING/Enemies/Act1/ShardWalker/animations/death/`
