...
### Nereye kaydet
**STAGING:** `F:/Antigravity Projeler/2d roguelite/_STAGING/`
...
```
Kaydet: `_STAGING/Characters/Players/Warblade/sprites.zip`
...
```
Kaydet: `_STAGING/Characters/Players/Elementalist/sprites.zip`
...
```
Kaydet: `_STAGING/Characters/Players/Shadowblade/sprites.zip`
...
```
Kaydet: `_STAGING/Characters/Players/Ranger/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/ShardWalker/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/SeamCrawler/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/VoidThrall/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/ChainWarden/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/Penitent/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/RelicCaster/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/FractureImp/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/IronWarden/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/TwiceBorn/Primary/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/TwiceBorn/Secondary/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/FractureKnight/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act1/Reliquary/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act2/MireStalker/sprites.zip`
...
```
Kaydet: `_STAGING/Enemies/Act2/RotPriest/sprites.zip`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Warblade/IronCharge.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Warblade/GravityCleave.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Warblade/WarStomp.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Warblade/DeathBlow.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Elementalist/Fireball.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Elementalist/GlacialSpike.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Elementalist/Blink.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Elementalist/Meteor.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Shadowblade/Backstab.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Shadowblade/Shadowstep.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Shadowblade/FanOfKnives.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Shadowblade/Vanish.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Ranger/AimedShot.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Ranger/RainOfArrows.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Ranger/ConcussiveArrow.png`
...
```
İndir → kaydet: `_STAGING/Icons/Skills/Ranger/EvasiveRoll.png`
...
```
İndir tile PNG → kaydet: `_STAGING/Tiles/Act1/floor_stone.png`
...
```
İndir tile PNG → kaydet: `_STAGING/Tiles/Act1/wall_stone.png`

---

## TAMAMLAMA

Her iş bitince `_STAGING/DONE.txt` dosyasına kaydet:
```
