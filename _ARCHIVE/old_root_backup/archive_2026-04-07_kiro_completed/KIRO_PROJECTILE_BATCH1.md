...
```
Kaydet: `_STAGING/Projectiles/Ranger/arrow_flight.png`
...
```
Kaydet: `_STAGING/Projectiles/Ranger/arrow_impact_hit.png`
...
```
Kaydet: `_STAGING/Projectiles/Ranger/arrow_impact_miss.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/fireball_flight.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/fireball_impact_hit.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/fireball_impact_miss.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/ice_spike_flight.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/ice_spike_impact_hit.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/ice_spike_impact_miss.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/wind_blade_flight.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/wind_blade_impact_hit.png`
...
```
Kaydet: `_STAGING/Projectiles/Elementalist/lightning_impact_hit.png`
...
```
Kaydet: `_STAGING/Projectiles/Melee/melee_impact_hit.png`
...
```
Kaydet: `_STAGING/Projectiles/Melee/heavy_impact_hit.png`
...
```
Kaydet: `_STAGING/StatusEffects/freeze_overlay.png`
...
```
Kaydet: `_STAGING/StatusEffects/stun_indicator.png`
...
```
Kaydet: `_STAGING/StatusEffects/wind_launched.png`
...
```
Kaydet: `_STAGING/StatusEffects/blink_out.png`
...
```
Kaydet: `_STAGING/StatusEffects/blink_in.png`
...
```
Kaydet: `_STAGING/BossVFX/aoe_tell_circle.png`
...
```
Kaydet: `_STAGING/BossVFX/aoe_tell_cone.png`
...
```
Kaydet: `_STAGING/BossVFX/aoe_tell_line.png`
...
Bitince `_STAGING/DONE.txt`'e ekle:
```
