...
Save: `_STAGING/Enemies/Act1/ShardWalker/sprites.zip` (overwrite existing)
...
Save: `_STAGING/Icons/Skills/Warblade/IronCharge.png`
...
Save: `_STAGING/Icons/Skills/Shadowblade/Shadowstep.png`
...
Save: `_STAGING/Icons/Skills/Ranger/EvasiveRoll.png`

---

## COMPLETION LOG

When done, append to `_STAGING/DONE.txt`:
```
