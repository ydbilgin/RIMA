Source: https://www.pixellab.ai/docs/tools/extend-map-old
...
An older version of the [Extend map](/docs/tools/map-tiles) tool.
...
* For tier 1, the canvas size must be smaller than or equal to 100x100.
* For tier 2 and above, the canvas size must be smaller than or equal to 160x160.
* This feature requires at least Tier 1.

## On this page

[Options](#options)[Guidance](#guidance)[Init image](#init-image)[Color](#color)[General](#general)[Limitations](#limitations)