Source: https://www.pixellab.ai/docs/tools/animate-with-text-pro
...
128px sprite → sadece 4 frame çıkıyor. 64px → 16 frame (daha akıcı animasyon için 64px tercih et).

## On this page

[How It Works](#how-it-works)[Frame Output by Reference Size](#frame-output-by-reference-size)[Options](#options)[Limitations](#limitations)