Source: https://www.pixellab.ai/docs/tools/rotate
...
![Quick Rotate Tool Icon](/docs/tools/quickrotate.png)
...
![Quick Rotate Tool Icon](/docs/tools/quickrotate-dragging.png)
...
[Improving the results](#improving-the-results)[Text tutorial](#text-tutorial)[Quick Rotate (Only Pixelorama)](#quick-rotate-only-pixelorama)[Video tutorials](#video-tutorials)[Options](#options)[Character](#character)[Color](#color)[Init image](#init-image)[General](#general)[Limitations](#limitations)