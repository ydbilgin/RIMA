Source: https://www.pixellab.ai/docs/tools/style_old
...
Create small-medium image with style support (old)

# Create small-medium image with style support (old)

*"Style-consistent image generation"*

The Create image (style, old) tool can be used to create a character or item in the same style as a reference image.

It also supports inpainting so you can gradually perfect your creation by freezing the parts you like and continuing to work on the rest using init images.

There is a detailed guide on how to use the tool in ["Getting started"](/docs/getting-started) and there is also this video tutorial:

## Options

* [Use inpainting](/docs/options/inpainting)
...
[Options](#options)[Guidance](#guidance)[Color](#color)[Init image](#init-image)[General](#general)[Limitations](#limitations)