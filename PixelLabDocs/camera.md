Source: https://www.pixellab.ai/docs/options/camera
...
When enabled, tries to control the *view* and *direction* of the output.
...
* *none*: Don't try to guide towards any specific view.
* *low top-down*: Looking down at approximately a 20 degree angle.
* *high top-down*: Looking down at approximately a 35 degree angle.
...
* *none*: Don't try to guide towards any specific direction.
* *north*: Facing away from the camera.
* *east*: Facing right.
...
* In many cases, the *west* and *east* cases are redundant since the generated image can be flipped horizontally.

## Map view

For create map, the available options are:

* *high top-down*: The maps are drawn from a bird's-eye view.
* *sidecroller*: The maps are drawn as in a sidescroller game.

## On this page

[Use view and directions](#use-view-and-directions)[View](#view)[Direction](#direction)[Tips](#tips)[Map view](#map-view)