Source: https://www.pixellab.ai/docs/options/color
...
* *No*: don't force any particular palette.
* *Color palette*: limit the colors to the current palette.
* *Current image*: limit the colors to the selected image's palette.
...
* *Auto*: Automatically selects the numbers of colors to use and then reduces the palette to this size.
* *Specify colors*: Selects a specific number of colors to reduce the palette to.
* *Use palette*: Recuce the colors to a specific palette.
...
[Limit colors used](#limit-colors-used)[Force colors](#force-colors)[Quantization method](#quantization-method)[Color reduction palette](#color-reduction-palette)[Number of Colors](#number-of-colors)