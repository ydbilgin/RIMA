...
ADIM 1: Base Mannequin → kamera açısı + canvas fill + battle body geometry kilitle
         ↓ onaylandı → _STAGING/base_pose_reference.png
ADIM 2: Warblade → base'i reference image yükle, class detay ekle
         ↓ onaylandı → _STAGING/warblade_reference.png  
...
> **Onaylandı mı?** → Kaydet: `_STAGING/base_pose_reference.png`
...
> **Onaylandı mı?** → Kaydet: `_STAGING/warblade_reference.png` — diğer 9 class için style anchor
