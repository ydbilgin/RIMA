...
2. `_STAGING/PIPELINE_8DIR_CHATGPT.md`: ayrintili kamera ve 8 yon prompt template.
3. `_STAGING/SKILL_REVIZYON_PLANI.md`: skill degisimlerinin gerekcesi.
4. `_STAGING/PROMPTS_RANGER_SHADOWBLADE.md`: Ranger ve Shadowblade icin hazir 8 yon prompt.
