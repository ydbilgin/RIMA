...
- `Assets/STAGING/PIXELLAB_RESEARCH.md` (create this file with your findings)
...
Fetch each URL below. Read the full content. Write your findings to `Assets/STAGING/PIXELLAB_RESEARCH.md`.
...
Write to `Assets/STAGING/PIXELLAB_RESEARCH.md`:
...
1. Read `Assets/STAGING/PIXELLAB_RESEARCH.md`
