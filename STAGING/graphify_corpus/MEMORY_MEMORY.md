...
| | [v15g + v15h Minimal PixelLab Pipeline](project_v15g_v15h_minimal_pixellab_pipeline.md) | **2026-05-18 LIVE/dispatched:** v15g clean (chaos gone, sparse). v15h = Wang v2 wire + density 85% + adjacency cap + Warblade spawn + WASD playtest. Q2 FULL PixelLab test parallel (v15d hybrid rollback preserved). |
...
| | [128px Pivot S43](project_128px_pivot_s43.md) | ⚠️ STALE — Karar #74 LIVE LOCK = 64×64; bu memory deprecate edilecek. |
...
| | [Map System](project_map_system.md) | STS2 DungeonMapUI, 3-fork depth. |
...
| | [Anim Notes](project_animation_notes.md) | ⚠️ STALE — 128px→64×64, 8-dir→4-cardinal V1; [[weaponless-animation-v1]] active spec. |
...
| | [Room Design](project_room_design.md) | 7 room types, dash lane philosophy. |
...
| | [Visual Quality](project_visual_quality.md) | ⚠️ "128px" stale; Karar #74 64×64 LIVE. Low Top-Down + Fractured Epic tone KEEP. |
