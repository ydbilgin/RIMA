# Test Room - Boss Arena (boss_arena)

## Layout Source
`STAGING/s106_overnight/stream_e_rooms/layouts/boss_arena.json`

## Generation
- Scene: `Assets/Scenes/Test/PainterTestE_boss_arena.unity`
...
## Screenshots
- Scene: `STAGING/s106_overnight/stream_e_rooms/boss_arena/scene.png`
- Gizmo: `STAGING/s106_overnight/stream_e_rooms/boss_arena/gizmo.png`

## Used Assets
| WallPieceData.id | Count | Notes |
|---|---:|---|
| connector | 6 | Placeholder V2 | 
| inner_corner | 2 | Placeholder V2 | 
| open_gap | 20 | Placeholder V2 | 
| outer_corner | 10 | Placeholder V2 | 
| rear_wall_3x | 4 | Placeholder V2 | 
| side_wall_1x | 3 | Placeholder V2 | 
| side_wall_2x | 2 | Placeholder V2 | 
| side_wall_3x | 1 | Placeholder V2 | 
...
- Score: 8/10
- Why? The wide arena, stepped sides, rear setpiece extension, and boss/wave sockets match the boss blueprint well, excluding missing props and real setpiece art.
