...
[Şekil 5: Çift veya üçlü Rift portalı çıkışı — oda türü simgeleri görünür]
...
Tüm 12 mob sprite'ı, kaynaktan üç kat büyütülmüş (nearest-neighbor) ve etiketlenmiş biçimde aşağıdaki kontak sheet'te bir arada sunulmuştur (bkz. Şekil 15). `hollow_hulk` hücresi boss rolünü vurgulamak için ayrıca işaretlenmiştir.

[Şekil 15: Act-1 mob kadrosu kontak sheet'i — 12 düşman sprite, 4×3 grid; Hollow Hulk boss olarak işaretli]

#### Oynanabilir Sınıf Kadrosu — 10 Sınıf Dizilimi

RIMA'da kilit açılabilir on oynanabilir sınıf tanımlıdır. Her sınıf `Assets/Resources/Characters/<Sınıf>/<sınıf>_idle_south.png` yolunda güney yönüne bakan idle sprite'a sahiptir. Aşağıdaki kontak sheet bu on sprite'ı yan yana, etiketli biçimde göstermektedir (bkz. Şekil 16). Demo'da Warblade ve Elementalist aktif; Shadowblade ve Ranger teknik olarak oynanabilir; kalan altı sınıf kilit sistemiyle Attunement Chamber'da yer alır.

[Şekil 16: Oynanabilir sınıf dizilimi kontak sheet'i — 10 sınıfın idle_south sprite'ları, etiketli 2×5 grid]
...
| Şekil 5 | Çift veya üçlü Rift portalı çıkışı — oda türü simgeleri görünür | 07_branching_doors.png |
| Şekil 6 | Warblade karakteri — omuz zırhı ve iki elli kılıç silueti | fig06_warblade.png |
...
| Şekil 15 | Act-1 mob kadrosu kontak sheet'i — 12 düşman + Hollow Hulk boss işaretli, 4×3 grid | mob_roster_sheet.png |
| Şekil 16 | Oynanabilir sınıf dizilimi kontak sheet'i — 10 sınıf idle_south sprite, 2×5 grid | class_lineup_sheet.png |
