...
- ⏭️ **Kalan minor .cs (yekta reset 07:05 sonrası veya kullanıcı):** ImpactFrameDriver (chromatic frame, `BUILD_IMPACTFRAME_CX.md` hazır) · screen-image wiring (load-if-present) · cliff-edge dust. **Büyük iş hep gated** (Unity restart + PixelLab + F5).
