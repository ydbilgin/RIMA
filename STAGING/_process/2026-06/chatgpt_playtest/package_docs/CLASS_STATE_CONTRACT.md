...
- **Consumers:** Pin Strike branch (Pulverize Cracked branch), Shattered upgrade gate; cross-class: Warblade Iron Crush bonus damage on Cracked
- **Readability:** white-blue crack overlay on enemy torso
- **Boss Rule:** boss Cracked applies but Pin Strike branch disabled, micro-stagger only
- **Abuse Cap:** Cracked decay 5s; max 3 stacks; 3 stacks -> Shattered conversion

### Wall-Slammed (public, Phase 2/Later)
- **Producer:** **Wall Slam Combo (Pulverize wall finisher branch, R4 reorganized)**
...
- **Phase:** Wall Slam Combo = **Later** (high collision/layout risk, NOT Phase 1 dependency)

### Pinned (internal)
- **Producer:** Pin Strike (Pulverize Cracked branch)
...
- **Consumers:** Pulverize damage bonus, Pin Strike conversion bonus
...
### Hexed (public)
- **Producer:** basic curse cast, Whisper Mark (Phase 2 passive aura), Curse Bargain
