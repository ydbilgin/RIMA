...
namespace MCPForUnity.Editor.Tools
{
    ...
    public static class ManageScene
    {
        private sealed class SceneCommand
        {
            ...
            public bool? forceDiscard { get; set; }      // for dirty-scene modal bypass
        }
            ...
            switch (action)
            {
                case "create":
                    ...
                    if (!string.IsNullOrEmpty(cmd.template))
                        return CreateSceneFromTemplate(fullPath, relativePath, cmd.template, cmd.forceDiscard ?? true);
        ...
        private static object CreateScene(string fullPath, string relativePath, bool forceDiscard = true)
        {
        ...
        private static object LoadScene(string relativePath, bool forceDiscard = true)
        {
            if (
                !File.Exists(
                    Path.Combine(
        ...
        private static object LoadScene(int buildIndex, bool forceDiscard = true)
        {
        ...
        private static object CreateSceneFromTemplate(string fullPath, string relativePath, string template, bool forceDiscard = true)
        {
            NewSceneSetup setup;
            switch (template)
            {
